...
var $author$project$Main$SubmitQueryWhileNavigating = function (a) {
...
var $author$project$Main$parseUrlForIndexQuery = function (url) {
	var subject = $elm$url$Url$Parser$Query$string('query');
	var parseQuery = A2(
...
var $author$project$Main$initialFn = F3(
	function (maybeServer, url, elmKey) {
		var serverFlag = function () {
			if (maybeServer.$ === 'Nothing') {
				return $author$project$Main$server;
			} else {
				var s = maybeServer.a;
				return s;
			}
...
var $author$project$Main$DisplayingSelectResult = F2(
	function (a, b) {
		return {$: 'DisplayingSelectResult', a: a, b: b};
	});
...
var $author$project$Main$downloadFile = F2(
...
var $author$project$Main$mainDecoder = A8(
	$elm$json$Json$Decode$map7,
	$author$project$Main$KGResponse,
	A2($elm$json$Json$Decode$field, 'server', $elm$json$Json$Decode$string),
	...
	A2($elm$json$Json$Decode$field, 'queryType', $elm$json$Json$Decode$string),
		...
		switch (msg.$) {
			...
			case 'PingServer':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{state: $author$project$Main$Pinging}),
					$author$project$Main$pingServer(model.server));
			case 'Pinged':
				var result = msg.a;
				if (result.$ === 'Ok') {
					...
					if (_v11 === 200) {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									state: $author$project$Main$DisplayingSelectError(okData.message)
								}),
							$elm$core$Platform$Cmd$none);
					}
				} else {
			...
			case 'FileLoaded':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							query: $author$project$PlaygroundQuery$establishQueryType(content)
						}),
					$elm$core$Platform$Cmd$none);
			case 'DownloadFile':
				return _Utils_Tuple2(
			...
			case 'ChangeOutputFormat':
				var outputFormat = msg.a;
				if (outputFormat.$ === 'Table') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{resultsDisplay: $author$project$Main$SubjectOrientation}),
						$elm$core$Platform$Cmd$none);
				}
...
var $author$project$Main$PingServer = {$: 'PingServer'};
...
var $author$project$Main$elOfServerInput = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_Nil,
		A2(
			...
			_List_fromArray(
				[
						...
						]),
					{
						...
						onChange: $author$project$Main$ChangeServer,
						placeholder: $elm$core$Maybe$Just(
							A2(
								$mdgriffith$elm_ui$Element$Input$placeholder,
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$centerY]),
								$mdgriffith$elm_ui$Element$text('http://your.api.server:port'))),
						text: model.server
					}),
					A2(
					$mdgriffith$elm_ui$Element$Input$button,
					...
					{
						label: $mdgriffith$elm_ui$Element$text('Connect'),
						onPress: $elm$core$Maybe$Just($author$project$Main$PingServer)
					})
				])));
};
...
var $author$project$Main$elOfHeading = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color($author$project$Main$colorPalette.header),
				$mdgriffith$elm_ui$Element$height(
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$Main$elOfServerInput(model),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
...
var $author$project$Main$sizePalette = {command: $author$project$Main$materialPalette.caption.size, highlight: $author$project$Main$materialPalette.h6.size, input: $author$project$Main$materialPalette.body1.size, normal: $author$project$Main$materialPalette.body2.size, smallPrint: $author$project$Main$materialPalette.overline.size, subject: $author$project$Main$materialPalette.h4.size};
...
var $author$project$Main$ChangeOutputFormat = function (a) {
	return {$: 'ChangeOutputFormat', a: a};
};
...
var $author$project$Main$elOfResultFormatToggle = function (model) {
	return A2(
			...
			]),
		{
			...
			onChange: $author$project$Main$ChangeOutputFormat,
			options: _List_fromArray(
				[
					A2(
					$mdgriffith$elm_ui$Element$Input$option,
					$author$project$Main$Table,
					$mdgriffith$elm_ui$Element$text('Table')),
					A2(
					$mdgriffith$elm_ui$Element$Input$option,
					$author$project$Main$SubjectOrientation,
					$mdgriffith$elm_ui$Element$text('Subjects'))
				]),
			selected: $elm$core$Maybe$Just(model.resultsDisplay)
		});
};
var $author$project$Main$DownloadFile = {$: 'DownloadFile'};
var $author$project$Main$FileRequested = {$: 'FileRequested'};
var $author$project$Main$elOfUploadQueryFromFile = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$spacing(5),
		...
		[
				...
				]),
			{
				label: A2(
					...
					$mdgriffith$elm_ui$Element$text('Load Query')),
				onPress: $elm$core$Maybe$Just($author$project$Main$FileRequested)
			}),
			A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_List_fromArray(
				...
				]),
			{
				label: A2(
					...
					$mdgriffith$elm_ui$Element$text('Download Query')),
				onPress: $elm$core$Maybe$Just($author$project$Main$DownloadFile)
			})
		]));
var $author$project$Main$elOfMainPage = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Main$colorPalette.background)
			]),
		_List_fromArray(
			[
				$author$project$Main$elOfHeading(model),
				$author$project$Main$elOfUploadQueryFromFile,
				$author$project$Main$elOfQueryPanel(model),
				$author$project$Main$elOfResultFormatToggle(model),
				$author$project$Main$elOfQueryHistory(model.queryHistory)
			]));
};
...
var $author$project$Main$Object = {$: 'Object'};
var $author$project$Main$Predicate = {$: 'Predicate'};
var $author$project$Main$RegisterSubjectPredicateOpen = function (a) {
...
var $author$project$Main$codeBlock = function (details) {
	return A2(
		$mdgriffith$elm_ui$Element$paragraph,
		_List_fromArray(
			[
...
var $author$project$Main$tableBorder = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Border$color(
...
var $author$project$Main$renderer = {
	...
	codeBlock: $author$project$Main$codeBlock,
	codeSpan: $author$project$Main$code,
	...
	tableCell: F2(
		function (maybeAlignment, children) {
			return A2($mdgriffith$elm_ui$Element$paragraph, $author$project$Main$tableBorder, children);
		}),
...
var $author$project$Main$elOfMarkdown = function (markdown) {
	return A2(
		$elm$core$Result$andThen,
		$dillonkearns$elm_markdown$Markdown$Renderer$render($author$project$Main$renderer),
		A2(
			$elm$core$Result$mapError,
			function (error) {
				return A2(
...
var $author$project$Main$elOfRdfNodeValue = function (node) {
	var leadingWhiteSpaceRe = A2(
		$elm$core$Maybe$withDefault,
		$elm$regex$Regex$never,
		A2(
			$elm$regex$Regex$fromStringWith,
	...
	switch (node.$) {
		...
		case 'LiteralValueAndDataType':
			...
			if (a.dataType === 'http://net.daringfireball.markdown') {
				var _v1 = $author$project$Main$elOfMarkdown(
					A3(
						$elm$regex$Regex$replace,
						leadingWhiteSpaceRe,
						function (_v2) {
...
var $author$project$Main$elOfObjects = F3(
	function (model, subj, po) {
		...
		var rest = A2(
			$elm$core$Maybe$withDefault,
			_List_Nil,
			$elm$core$List$tail(objs));
		var restCount = $elm$core$List$length(rest);
		if (head.$ === 'Just') {
			var obj = head.a;
			if (!restCount) {
			...
			switch (node.$) {
				...
				case 'LiteralValueAndDataType':
					...
					return A2(
						...
						_List_fromArray(
							[
								$author$project$Main$elOfRdfNodeValue(node),
								A2(
								$mdgriffith$elm_ui$Element$row,
								_List_fromArray(
									[
...
var $author$project$Main$elOfSubjects = function (model) {
	var _v0 = model.currentRdfDict;
	if (_v0.$ === 'Nothing') {
		return $mdgriffith$elm_ui$Element$text('rdfdict error');
	} else {
		var a = _v0.a;
		return A2(
			$mdgriffith$elm_ui$Element$column,
			...
			$elm$core$List$map(
				function (spo) {
					return A2($author$project$Main$viewSubjectMolecule, model, spo);
				})(
				$elm$core$Dict$values(a)));
	}
};
var $elm_community$list_extra$List$Extra$zip = $elm$core$List$map2($elm$core$Tuple$pair);
var $author$project$Main$makeDict = F2(
	function (vars, atom) {
		return $elm$core$Dict$fromList(
			A2(
...
var $author$project$Main$elOfTabularResults = F2(
	function (vars, result) {
		var data = A2(
			$elm$core$List$map,
			function (r) {
				return A2($author$project$Main$makeDict, vars, r);
			},
			result);
		var columns = A2(
			$elm$core$List$map,
...
var $author$project$GraphDisplay$convertMoleculeGraph = function (g) {
	return A2(
...
var $author$project$GraphDisplay$updateContextWithValue = F2(
...
var $author$project$GraphDisplay$updateGraphWithList = function () {
	var graphUpdater = function (value) {
		return $elm$core$Maybe$map(
			function (ctx) {
				return A2($author$project$GraphDisplay$updateContextWithValue, ctx, value);
			});
	};
...
var $gampleman$elm_visualization$Scale$Sequential$convert = F3(
	function (_v0, interpolator, x) {
		var x0 = _v0.a;
		var x1 = _v0.b;
		return interpolator((x - x0) / (x1 - x0));
	});
var $gampleman$elm_visualization$Scale$sequential = F2(
	function (interpolator, domain_) {
		return $gampleman$elm_visualization$Scale$Scale(
			{convert: $gampleman$elm_visualization$Scale$Sequential$convert, domain: domain_, range: interpolator});
	});
...
var $author$project$GraphDisplay$colorScale = A2(
	$gampleman$elm_visualization$Scale$sequential,
	$gampleman$elm_visualization$Scale$Color$viridisInterpolator,
	_Utils_Tuple2(200, 700));
...
var $author$project$GraphDisplay$linkElement = F2(
	function (graph, edge) {
		var retrieveEntity = A2(
			...
			$elm$core$Maybe$withDefault(
				A2(
					$gampleman$elm_visualization$Force$entity,
					0,
					A2($author$project$GraphDisplay$CustomNode, 0, ''))),
			$elm$core$Maybe$map(
				A2(
					$elm$core$Basics$composeR,
					function ($) {
			...
			_List_fromArray(
				[
					...
					$elm_community$typed_svg$TypedSvg$Types$Paint(
						A2($gampleman$elm_visualization$Scale$convert, $author$project$GraphDisplay$colorScale, source.x))),
...
var $author$project$GraphDisplay$hexagon = F3(
	function (_v0, size, attrs) {
		var x = _v0.a;
		var y = _v0.b;
		var angle = (2 * $elm$core$Basics$pi) / 6;
		var p = $elm_community$typed_svg$TypedSvg$Attributes$points(
			A2(
				$elm$core$List$map,
				function (a) {
					return _Utils_Tuple2(
						x + ($elm$core$Basics$cos(a * angle) * size),
						y + ($elm$core$Basics$sin(a * angle) * size));
				},
				A2(
					$elm$core$List$map,
					$elm$core$Basics$toFloat,
...
var $author$project$GraphDisplay$nodeSize = F2(
	function (size, node) {
		return A4(
			$author$project$GraphDisplay$hexagon,
			...
			_List_fromArray(
				[
					...
					$elm_community$typed_svg$TypedSvg$Types$Paint(
						A2($gampleman$elm_visualization$Scale$convert, $author$project$GraphDisplay$colorScale, node.x)))
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$GraphDisplay$nodeElement = function (node) {
	return (node.label.value.rank < 5) ? A2($author$project$GraphDisplay$nodeSize, 4, node.label) : ((node.label.value.rank < 9) ? A2($author$project$GraphDisplay$nodeSize, 7, node.label) : ((!A2($elm$core$Basics$modBy, 2, node.label.value.rank)) ? A2(
		$elm_community$typed_svg$TypedSvg$g,
		_List_Nil,
		_List_fromArray(
			[
				A2($author$project$GraphDisplay$nodeSize, 9, node.label),
				A2(
				$elm_community$typed_svg$TypedSvg$circle,
				_List_fromArray(
					[
						$elm_community$typed_svg$TypedSvg$Attributes$InPx$r(12),
						...
						$elm_community$typed_svg$TypedSvg$Attributes$stroke(
						$elm_community$typed_svg$TypedSvg$Types$Paint(
							A2($gampleman$elm_visualization$Scale$convert, $author$project$GraphDisplay$colorScale, node.label.x)))
					]),
				_List_Nil)
			])) : A2($author$project$GraphDisplay$nodeSize, 10, node.label)));
};
...
var $author$project$GraphDisplay$view = function (model) {
	return A2(
		$elm_community$typed_svg$TypedSvg$svg,
		_List_fromArray(
			[
				A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 0, $author$project$GraphDisplay$w, $author$project$GraphDisplay$h)
			]),
		_List_fromArray(
			[
				A2(
				...
				A2(
					$elm$core$List$map,
					$author$project$GraphDisplay$linkElement(model),
				...
				A2(
					$elm$core$List$map,
					$author$project$GraphDisplay$nodeElement,
...
var $author$project$Main$view = function (model) {
	return {
						...
						if (error.$ === 'BadBody') {
							...
							return A2(
								...
								A2(
									...
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$text('ApiError: I can\'t interpret the response'),
												...
												]),
											{
												...
												onPress: $elm$core$Maybe$Just($author$project$Main$BackToQuery)
											})
										])));
						} else {
							return A2(
								...
								A2(
									...
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$text('ApiError: Oops - something went wrong! :-('),
											A2(
											$mdgriffith$elm_ui$Element$Input$button,
											_List_fromArray(
												[
		...
		title: 'Sparql Query Playground - 0.0'
	};
};
