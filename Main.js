...
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$browser$Browser$Events$onKeyDown($author$project$Main$msgDecoder);
};
...
var $author$project$Main$elOfTabularResults = F2(
	function (vars, result) {
		...
		var columns = A2(
			...
			function (v) {
				return {
					header: $mdgriffith$elm_ui$Element$text(v),
					view: function (x) {
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$name('predicateStyle'),
						$elm$html$Html$Attributes$value('verbose'),
						$elm$html$Html$Attributes$checked(
						_Utils_eq(selected, $author$project$Main$Verbose)),
						$elm$html$Html$Events$onInput($author$project$Main$ChangePredicateStyle)
					]),
				_List_Nil),
				$elm$html$Html$text('Verbose'),
				A2(
				$elm$html$Html$input,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$type_('radio'),
						$elm$html$Html$Attributes$name('predicateStyle'),
						$elm$html$Html$Attributes$value('terse'),
						$elm$html$Html$Attributes$checked(
						_Utils_eq(selected, $author$project$Main$Terse)),
						$elm$html$Html$Events$onInput($author$project$Main$ChangePredicateStyle)
					]),
				_List_Nil),
				$elm$html$Html$text('Terse')
			]));
};
...
var $author$project$Main$queryInput = F2(
	function (newServer, query) {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
...
var $author$project$Main$uploadQueryFromFile = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Load query')
				])),
			A2(
			$elm$html$Html$button,
			_List_fromArray(
				[
					$elm$html$Html$Events$onClick($author$project$Main$DownloadFile)
				]),
			_List_fromArray(
				[
							...
							return A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('ApiError: I can\'t interpret the response')
											])),
										A2(
										$elm$html$Html$div,
										_List_Nil,
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick($author$project$Main$BackToQuery)
											]),
										_List_fromArray(
											[
							...
							return A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('ApiError: Oops - something went wrong! :-(')
											])),
										A2(
										$elm$html$Html$button,
										_List_fromArray(
								...
								return A2(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text('Subject orientation')
												])),
								...
								return A2(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text('Subject orientation only where results are in the shape of ?s ?p ?o')
												]))
										]));
							}
						}
