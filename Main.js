...
var $author$project$Main$DownloadResultsAsCSV = F2(
	function (a, b) {
		return {$: 'DownloadResultsAsCSV', a: a, b: b};
	});
...
var $author$project$Main$resultFormatToggle = function (selected) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$type_('radio'),
						$elm$html$Html$Attributes$name('resultFormat'),
						$elm$html$Html$Attributes$value('table'),
						$elm$html$Html$Attributes$checked(
						_Utils_eq(selected, $author$project$Main$Table)),
						$elm$html$Html$Events$onInput($author$project$Main$ChangeOutputFormat)
					]),
				_List_Nil),
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$checked(
						_Utils_eq(selected, $author$project$Main$SubjectOrientation)),
						$elm$html$Html$Events$onInput($author$project$Main$ChangeOutputFormat)
					]),
				_List_Nil),
				$elm$html$Html$text('Subjects')
			]));
};
...
var $author$project$Main$tableView = F2(
...
var $author$project$Main$viewSubjectMolecule = F4(
	function (spoKey, openPredicates, predicateStyle, subjM) {
		if (subjM.$ === 'Nothing') {
			return $elm$html$Html$text('Lost subject molecule');
		} else {
			var a = subjM.a;
			return A2(
				$elm$html$Html$div,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('/index.html?query=describe <' + (spoKey + '>'))
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(spoKey)
									]))
							])),
						A3($author$project$Main$viewPredicates, openPredicates, predicateStyle, a)
					]));
		}
	});
				...
				function (spoKey) {
					return A2(
						...
						_List_fromArray(
							[
								A4(
								$author$project$Main$viewSubjectMolecule,
								spoKey,
								openPredicates,
								predicateStyle,
								A2($elm$core$Dict$get, spoKey, subjs))
							]));
				},
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$href('http://www.cnn.com')
												]),
											_List_fromArray(
												[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$placeholder('Server'),
													$elm$html$Html$Events$onInput($author$project$Main$ChangeServer),
											...
											_List_fromArray(
												[
													$elm$html$Html$Events$onClick($author$project$Main$PingServer)
												]),
											_List_fromArray(
												[
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									$author$project$Main$resultFormatToggle(model.resultsDisplay)
								]));
					case 'Waiting':
						return A2(
							$elm$html$Html$div,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick(
												A2($author$project$Main$DownloadResultsAsCSV, vars, result))
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('Download csv')
											])),
										A2($author$project$Main$tableView, vars, result)
									]));
						} else {
							var contracted = A2(
								$elm$core$Maybe$map,
